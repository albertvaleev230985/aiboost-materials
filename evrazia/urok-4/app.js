// Утилиты web-аппа финального урока ГК Евразия AI Boost

const LS_PREFIX = 'aiboost_evrazia_u4:';
...
export function renderHeader(me, opts = {}) {
  ...
  el.innerHTML = `
    <div class="brand"><span class="brand-dot"></span>neovida · AI Boost · ГК Евразия · финал</div>
    ${me ? `
      <div class="user-chip">
  ...
  return `
    <div class="cert-celebrate">
      ...
      <div class="cert-celebrate-body">
        Ты&nbsp;прошёл(а) корпоративный курс <strong>AI Boost для ГК Евразия</strong> и&nbsp;получил(а) персональный сертификат.
