// Утилиты web-аппа занятия 8 (очный поток 5, старт 20.08)

const LS_PREFIX = 'aiboost_l8_offline5:';
...
// «азат аминев» → «Азат Аминев», «иРИНА чулкова» → «Ирина Чулкова», дефисные части тоже с заглавной
...
export function certificateScreenHTML(name, report) {
  ...
  // Локально: веб-апп/ <-> сертификаты/ (кириллица). На сайте: final/ <-> final/certificate/ (латиница).
  ...
  return `
    <div class="cert-celebrate">
      ...
      <div class="cert-celebrate-body">
        Ты&nbsp;прошёл(а) восемь занятий курса <strong>«ИИ. Новая реальность»</strong>: чат, который знает тебя, свои ассистенты, навыки, агент в&nbsp;Codex и&nbsp;визуальный стандарт бренда. Печатный сертификат вручается на&nbsp;руки, электронный открывается кнопкой.
      </div>
      ...
      <div class="cert-celebrate-foot">
        Откроется в&nbsp;новой вкладке, там кнопка <strong>«Скачать PDF»</strong>. Следующий шаг: «AI&nbsp;Цех», старт 21&nbsp;сентября, подробности в&nbsp;шпаргалке занятия.
      </div>
    </div>
  `;
}
