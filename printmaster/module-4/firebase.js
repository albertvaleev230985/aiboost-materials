// Firebase Realtime Database — live-синхронизация финального урока PrintMaster
// Проект: ai-boost-8195c, раздел /printmaster-module-4/
...
const ROOT = 'printmaster-module-4';

// ===== Структура БД =====
// printmaster-module-4/
//   session/
