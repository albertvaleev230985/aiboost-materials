// Утилиты web-аппа финального урока PrintMaster AI Boost

const LS_PREFIX = 'aiboost_printmaster_m4:';
...
export function renderHeader(me, opts = {}) {
  ...
  el.innerHTML = `
    <div class="brand"><span class="brand-dot"></span>neovida · AI Boost · PrintMaster · финал</div>
    ${me ? `
      <div class="user-chip">
...
export function certificateScreenHTML(name) {
  ...
  // На materials.neovida.ai: module-4/ <-> module-4/certificate/ (English, flat).
  ...
  return `
    <div class="cert-celebrate">
      ...
      <div class="cert-celebrate-body">
        Ты&nbsp;прошёл(а) корпоративный курс <strong>AI Boost для PrintMaster</strong> и&nbsp;получил(а) персональный сертификат.
        Скачай его&nbsp;— впереди внедрение в&nbsp;реальные рабочие процессы.
      </div>
